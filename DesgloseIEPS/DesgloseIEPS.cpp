...
// DesgloseIEPS.cpp: define los comportamientos de las clases para la aplicación.
//
...
BEGIN_MESSAGE_MAP(CDesgloseIEPSApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Construcción de CDesgloseIEPSApp

CDesgloseIEPSApp::CDesgloseIEPSApp()
{
...
// Único objeto CDesgloseIEPSApp

CDesgloseIEPSApp theApp;


// Inicialización de CDesgloseIEPSApp

BOOL CDesgloseIEPSApp::InitInstance()
{
